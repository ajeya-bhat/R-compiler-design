...
LOOPS
      ...
      | IF '(' COND ')' CONDBODY   {$$ = buildTree("IF",$3,$5);}
      | IF '(' COND ')' CONDBODY ELSE CONDBODY  {$$ = buildTree("IF-ELSE",buildTree("IF",$3,$5),buildTree("ELSE",$7,NULL));}
      ;
...
CONDBODY
  	  : T_BROPEN R T_BRCLOSE {$$ = buildTree("CONDITIONAL-BODY",$2,NULL);}
  	  | statement {$$ = $1;}
  	  ;
...
PRNT :  PRINT '(' PRINTEXPR ')' {$$ = buildTree("FUNC_CALL","print",$3);} | PRINT '(' STRING ')' ;
